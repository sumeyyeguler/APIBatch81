...
public class Get08a extends GoRestBaseUrl {
  /*
        Given
    ...
    public void get11(){
        ...
        //eger calismazsa response.jsonPath().prettyPrint();
        ...
        List<String> femaleNames = response.jsonPath().getList("data.findAll{it.gender=='female'}.name"); //tek tırnak kullanıyoruz
